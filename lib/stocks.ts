...
export const STOCKS: StockMeta[] = [
  ...
  { id: "AXISBANK", name: "Axis Bank", sector: "Banking" },
  ...
  { id: "DABUR", name: "Dabur India", sector: "FMCG" },
  ...
  { id: "MM", name: "Mahindra & Mahindra", sector: "Auto" },
  ...
  { id: "PIDILITIND", name: "Pidilite Industries", sector: "Consumer/Specialty" },
